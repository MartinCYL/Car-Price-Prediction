...
print(vif_values)
##These VIF values are all below the usual thresholds (5 or 10), indicating that there is no serious multicollinearity among the independent variables in this model.
